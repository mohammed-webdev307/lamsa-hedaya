...
import { WRAPPING_COLORS, OCCASIONS } from '@/data/store';
import {
  formatPrice,
  buildWhatsAppUrl,
    ...
    return (
      <div className="pt-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-10 h-10 border-4 border-beige-200 border-t-gold-500 rounded-full animate-spin mx-auto mb-4" />
    ...
    return (
      <div className="pt-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-brown-400 mb-5">
      ...
      <div className="container-lux">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-6">
          ...
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-brown-700 mb-3">
              {product.name}
            </h1>
            ...
            <div className="flex items-baseline gap-3 mb-4">
              ...
              <span className="text-3xl font-bold text-brown-700">
                {formatPrice(product.price)}
              </span>

              {product.oldPrice && (
                <span className="text-lg text-brown-300 line-through">
                  {formatPrice(
                    product.oldPrice
                  )}
                </span>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="w-12 text-center font-bold text-brown-700 text-lg">
                  {quantity}
                </span>
            ...
            <div className="bg-cream-50 rounded-2xl p-5 mb-6 border border-beige-100">
              ...
              <h3 className="font-bold text-brown-700 mb-4">
                خيارات التخصيص
              </h3>
        ...
        <div className="mt-12 bg-cream-50 rounded-2xl p-6 sm:p-8 border border-beige-100">
          ...
          <p className="text-brown-500 leading-relaxed text-base">
            {product.description}
          </p>
        ...
        {relatedProducts.length >
          ...
          <div className="mt-12">
            ...
            <h2 className="text-xl font-bold text-brown-700 mb-6">
              منتجات مشابهة
            </h2>
